<template>
                ...
                <div class="w-1/2">
                    ...
                    <div class="hidden md:block">
                        ...
                        <a class="text-link more-link" @click="handleMoreMenu">
                            <span>Thêm</span>
                            <div class="arrow-icon" :class="{open: isShowMoreMenu}">
    ...
    .text-link {
        @apply py-2 px-4 font-[500] text-[14px] tracking-[0.02em];
        transition: 0.3s;
        &:hover,
        &:active,
        &.active {

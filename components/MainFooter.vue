<template>
    <footer class="text-white main-footer ">
      <div class="wrapper">
        <section>
          <ul>
            <li class="text-[24px] font-[800] tracking-[0.07em]">Thiên Quang Ni Tự</li>
            <li>
              © 2023 by Uptech.vn. All rights reserved.
            </li>
          </ul>
          <ul>
            <li class="text-[16px]"><strong>Chịu trách nhiệm: Huỳnh Thanh Sang</strong></li>
            <li class="text-[16px]">Địa chỉ: 15 Khu Phố Đông A, Tân Hòa, Dĩ An, Bình Dương</li>
          </ul>
          <ul>
            <li class="text-[16px]"><strong>Email:</strong> <a class="footer-btn" href="mailto:htsang1939@gmail.com">htsang1939@gmail.com</a></li>
            <li class="text-[16px]"><strong>Điện thoại:</strong> <a class="footer-btn" href="tel:htsang1939@gmail.com">0583179289</a></li>
          </ul>
        </section>
        <hr class="mt-5 mb-2 border-gray-300" />
        <div class="flex justify-center items-center w-full mt-[20px]">
          <ul class="flex flex-col justify-center items-center">
            <li class="text-[18px]">
              <strong>Kết nối với Thiên Quang</strong>
            </li>
            <div class="flex mt-3 gap-x-3">
              <div class="w-[45px]">
                <a
                  rel="noreferrer"
                  href="https://www.facebook.com/sang.huynhthanh.583"
                  target="_blank"
  ...
  .main-footer {
    ...
    .wrapper {
      background-image: url('../static/background/icon-3.png');
  ...
  section {
    ...
    > * {
      @apply w-full pt-5 md:w-1/3 px-3;
    }
  }
  </style>

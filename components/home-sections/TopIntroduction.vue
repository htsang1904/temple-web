<template>
    <section id="top-introduction" class="w-full lg:h-[500px] min-h-[500px] bg-thienquang-yellow">
        <div class="wrapper h-full flex justify-between items-center lg:flex-row flex-col">
            ...
            <div class="w-full lg:w-2/3 lg:pl-[40px] py-[10px] text-thienquang-purple text-[18px] font-[400] tracking-[0.03em] leading-9">
                <div class="text-[34px] font-[700] tracking-[0.02em] leading-10 pb-[16px] text-center">
